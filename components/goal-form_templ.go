...
func GoalForm(achievedGoals []services.Goal) templ.Component {
	return templruntime.GeneratedTemplate(func(templ_7745c5c3_Input templruntime.GeneratedComponentInput) (templ_7745c5c3_Err error) {
		...
		templ_7745c5c3_Var2 := templruntime.GeneratedTemplate(func(templ_7745c5c3_Input templruntime.GeneratedComponentInput) (templ_7745c5c3_Err error) {
			...
			ctx = templ.InitializeContext(ctx)
			_, templ_7745c5c3_Err = templ_7745c5c3_Buffer.WriteString("<form action=\"/goal\" method=\"post\" hx-post=\"/goal\" hx-push-url=\"true\" hx-target=\"body\"><label for=\"name\">Do this:</label> <input type=\"text\" id=\"name\" name=\"name\"> <label for=\"deadline\" class=\"mt-1-rem\">By then:</label> <input type=\"datetime-local\" id=\"deadline\" name=\"endDate\" value=\"2024-11-03T20:25\"> <input type=\"submit\" value=\"Set Goal\" class=\"mt-2-rem\"></form>")
			if templ_7745c5c3_Err != nil {
